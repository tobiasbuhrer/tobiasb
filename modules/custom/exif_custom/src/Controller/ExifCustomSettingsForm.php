...
namespace Drupal\exif_custom\Controller;

use Drupal\exif_custom\ExifCustomFactory;
...
class ExifCustomSettingsForm extends ConfigFormBase implements ContainerInjectionInterface {
  /**
   * The entity manager.
   *
  ...
  public function getFormId() {
    return 'exif_custom_settings';
  }

  protected function getEditableConfigNames() {
    return [
      'exif_custom.settings',
    ];
  }

  public function buildForm(array $form, FormStateInterface $form_state) {

    $config = $this->config('exif_custom.settings');
    ...
    $form['extraction_solution'] = array(
      ...
      '#options' => ExifCustomFactory::getExtractionSolutions(),
    ...
    $form['vocabulary'] = array(
      ...
      '#description' => t('Select vocabulary which should be used for iptc & exif data.').t('If you think no vocabulary is usable for the purpose, take a look at <a href="/admin/config/media/exif_custom/helper">the quick start page</a>.').t('To have a sample of metadata content, take a look at <a href="/admin/config/media/exif_custom/sample">the sample page</a>.'),
    );
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->config('exif_custom.settings')
