...
class ExifCustomSettingsController extends ControllerBase {
  ...
  public function createPhotographyVocabulary() {
    ...
    $response = new RedirectResponse('/admin/config/media/exif_custom/helper');
    $response->send();
    exit();
  }
  ...
  public function showSample() {
    ...
    $exif = Drupal\exif\ExifCustomFactory::getExifInterface();
