<?php
/**
 * @file ExifCustomHelpomHelp.php
 * @Contains \Drupal\exif\ExifCustomHelp
 */

namespace Drupal\exif_custom;

use Drupal\exif_custom\ExifCustomInterface;
use Drupal\Core\Url;
use Drupal\Component\Utility\SafeMarkup;

class ExifCustomHelp {
  ...
  static function content() {
    ...
    $rows = array();
    $help = '';
    //TODO drupal_add_css(drupal_get_path('module', 'exif') . '/exif_custom.admin.css');
    $exif = ExifCustomFactory::getExifInterface();
