...
namespace Drupal\exif_custom\Plugin\Field\FieldWidget;
 ...
 * )
 */
class ExifCustomHiddenWidget extends ExifCustomFieldCustomWidgetBase {
  /**
   * {@inheritdoc}
   */
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    //$form['#attached']['css'][] = drupal_get_path('module', 'exif') . '/exif_custom.css';
    $element += array(
      '#type' => '#hidden',
      '#value' => '',
