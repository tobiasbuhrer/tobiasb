...
namespace Drupal\leaflet_geoman_widget\Plugin\Field\FieldWidget;
 ...
 * @FieldWidget(
 *   id = "leaflet_geoman",
 *   label = @Translation("Leaflet Geoman"),
 ...
 * )
 */
class LeafletGeomanWidget extends GeofieldDefaultWidget {
  ...
  public function formElement(
    ...
    $json_element_name = 'leaflet-geoman-widget-input';
    ...
    // Leaflet.draw plugin.
    $element['map']['#attached']['library'][] = 'leaflet_geoman_widget/leaflet-geoman-widget';

    // Settings and geo-data are passed to the widget keyed by field id.
    $element['map']['#attached']['drupalSettings']['leaflet_geoman_widget'][$element['map']['#map_id']] = $js_settings;
