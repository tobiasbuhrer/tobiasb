...
namespace Drupal\Tests\juicebox\FunctionalJavascript;
 ...
 * @group Juicebox
 */
class JuiceboxSubRequestCaseTest extends JuiceboxCaseTestBase {
  ...
  // JuiceboxBaseCasetTest::initNode() to add fields and attach them to a node, and
