...
namespace Drupal\more_leaflet_markers\Plugin\Field\FieldFormatter;
...
/**
 * Plugin implementation of the 'leaflet_field_formatter' formatter.
 *
 * @FieldFormatter(
 *   id = "leaflet_field_formatter",
 *   label = @Translation("Leaflet field formatter"),
 *   field_types = {
 *     "geofield"
 *   }
 * )
 */
class LeafletFieldFormatter extends FormatterBase implements ContainerFactoryPluginInterface {
